...
import com.project.insurancesurveyorexam.Fragments.PastTestOverviewFragment
import com.project.insurancesurveyorexam.Fragments.UpcomingTestOverviewFragment
import com.project.insurancesurveyorexam.R
import com.project.insurancesurveyorexam.databinding.PastTestListItemBinding
import com.project.insurancesurveyorexam.databinding.UpcomingTestListItemBinding
import com.project.insurancesurveyorexam.datafiles.UpcomingTestDataFile
import java.text.SimpleDateFormat
import java.util.*

class PastTestAdapter (
    private val LinkList: ArrayList<UpcomingTestDataFile>
) :

    RecyclerView.Adapter<PastTestAdapter.MyViewHolder>() { //class  which will take prameter(list of strings)
// ------------------------------------------------------------------------------------------------------------------------------------------


    private lateinit var binding: PastTestListItemBinding
    ...
    override fun onCreateViewHolder(
        ...
        binding =
            PastTestListItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    private fun fragmentJump(
        ...
        val mFragment = PastTestOverviewFragment()
        switchContent(
            R.id.live_container,
            mFragment,
            context,
    ...
    class MyViewHolder(
        ItemViewBinding: PastTestListItemBinding,
    ) :
